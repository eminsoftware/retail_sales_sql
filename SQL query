...
-- 4) Retrieve all transactions where the category is 'Clothing' 
...
-- 8) Find the total count of transactions made by each gender in each category:
select 
	category, 
	gender,
...
-- 12) Create time shifts and number of orders in each shift (Morning <12, Afternoon Between 12 & 17, Evening >17)
with hourly_sale
as 
	(select 
		*, 
